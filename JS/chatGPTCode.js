...
async function displayAlbums() {
    ...
    for (let a of anchors) {
        if (a.href.includes("/songs/")) {
            ...
            try {
                const metaRes = await fetch(`http://127.0.0.1:5500/songs/${folder}/info.json`);
                ...
                cardContainer.innerHTML += `
                    <div data-folder="songs/${folder}" class="card">
                        ...
                        <img src="/songs/${folder}/Cover.jfif" onerror="this.src='fallback.jpg'" alt="Cover">
                        <h2>${meta.title}</h2>
